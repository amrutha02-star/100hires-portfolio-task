...
- Read the full content before trusting it, and cut what did not hold up. It is easy to add someone just because their video title matches the topic. So I read each transcript end to end and asked two things: does it actually deliver useful substance, and does it fit the quality-first idea of the set. Some did not pass. Eric Nowoslawski's video was all about sending six million emails a month, the opposite of the careful approach the rest of the set teaches, so I dropped him. One of Josh Braun's videos only teased an idea without delivering it, so I removed it and kept his stronger one. A cold calling pick turned out, once I watched it, to be about email rather than the phone, so it went too. For the phone channel I went with Kevin Hopp, but not the first video I found: it was from 2022 and was half a product demo for a dialer tool, so I dropped it and used a recent LinkedIn post of his that covers the same ideas cleanly. For the LinkedIn channel I went with Laura Erdem, but I watched two of her interviews first and only kept the one that clearly tied social selling to pipeline; the other leaned into marketing measurement, so I left it out. For discovery and qualification I went with Jen Allen-Knuth, but not her cold email posts, which would have repeated what Josh and Jason already cover, and not her best video on the topic either, because it was from 2024. I used a recent post of hers on cost of inaction, the part of the pipeline none of the others touch. I also held off on Jed Mahrle because his topics (cold email, outbound systems) were already covered by Jason Bay and Mark Colgan. I would rather leave a slot open than keep something that repeats the set, fights its main idea, or only sounds relevant.
